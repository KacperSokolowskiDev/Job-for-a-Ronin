const samurai = [
  {
    ...
    city: "Edo",
    description:
      "Served Tokugawa clan as a samurai, credited with saving the life of Tokugawa Ieyasu and then helping him to become the ruler of united Japan.",
  ...
  },
  {
    ...
    img: "Fuma_Kotaro.jpg",
    city: "Sagami Province",
    description:
      "The clan was based in Kanagawa Prefecture, specializing in horseback guerrilla warfare and naval espionage. When the Tokugawa shogunate came to power, the remnants of Fūma-ryū were reduced to a band of brigands operating in and around Edo.",
    skills: ["Ninja Arts"],
  },
  {
    ...
    img: "Honda-Tadakatsu.jpg",
    city: "Edo",
    description:
      "Served Tokugawa Ieyasu. Honda Tadakatsu was one of the Tokugawa Four Heavenly Kings along with Ii Naomasa, Sakakibara Yasumasa and Sakai Tadatsugu.",
